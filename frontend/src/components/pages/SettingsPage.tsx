...
export default function SettingsPage({ theme, onToggleTheme, autoStart, onToggleAutoStart, session, onVerify, onUpgrade, onCopyClientId, verifying, gauthEnabled, tunnels, onExportTunnels, onImportTunnels }: Props) {
